...
" This is modified to only handle the cterm color assignment, which
" seems to be exactly the same for every Base16 scheme.
...
call <sid>hi("IncSearch",      s:cterm00, s:cterm0A, "none")
...
call <sid>hi("Search",         s:cterm00, s:cterm0A,  "")
